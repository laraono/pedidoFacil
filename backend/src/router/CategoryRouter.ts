...
categoryRouter.post(
    ...
    catchAsync((req: Request, res: Response) => categoryController.createCategory(req, res))
);
...
categoryRouter.put(
    ...
    catchAsync((req: Request, res: Response) => categoryController.updateCategory(req, res))
);
