    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <section class="lg:col-span-1">
        <div class="bg-dark-card border border-white/5 rounded-[2.5rem] p-8 shadow-xl flex flex-col items-center">
          <h3 class="text-base font-black text-white mb-6 w-full text-left uppercase tracking-widest text-[11px]">Logo da Marca</h3>
      ...
      <section class="lg:col-span-2">
        <div class="bg-dark-card border border-white/5 rounded-[2.5rem] p-8 shadow-xl">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-1.5">
              <label class="text-xs font-black uppercase tracking-widest text-gray-300 ml-1">WhatsApp / Contato</label>
              <input
                :value="form.phone"
            ...
            <div class="space-y-1.5">
              <div class="flex justify-between items-center ml-1 mr-1">
                <label class="text-xs font-black uppercase tracking-widest text-gray-300">Sobre o Estabelecimento</label>
