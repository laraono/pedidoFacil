    ...
    >
      ...
      >
        ...
        <div class="flex flex-1 overflow-hidden relative">
          <aside
            class="w-1/3 sm:w-64 overflow-y-auto custom-scrollbar p-3 sm:p-4 border-r border-white/5 shrink-0"
          >
            <button
            ...
            >
              <template v-if="category.image">
                ...
                <div
                  ...
                  :style="{
                    ...
                    opacity: activeCategoryId === category.id ? 0.6 : 0,
                  }"
                ></div>
                <div
              ...
              <span
                ...
                :class="
                  category.image
                    ? 'text-white text-lg font-black drop-shadow-lg'
          ...
          >
              ...
              >
                ...
                >
                  ...
                  <div class="flex-1 z-10">
                    <h3
                      class="font-bold text-xl mb-2 leading-tight"
                      :style="{ color: textColor }"
                    >
                      {{ product.name }}
                    </h3>
                  ...
                  <div
                    class="flex items-center justify-between mt-6 pt-4 border-t border-white/5 z-10"
                  >
            ...
            >
              <ChefHat
                ...
                :style="{ color: textColor }"
              />
              <p class="text-lg font-bold mb-2" :style="{ color: textColor }">
                Sem itens disponíveis no cardápio
              </p>
            ...
            >
              ...
              >
                ...
                <div v-if="currentProduct?.sizes?.length > 0" class="space-y-3">
                  <h4
                    class="font-bold uppercase tracking-wider text-sm opacity-70"
                  >
                    Escolha o Tamanho
                  </h4>
                ...
                <div class="space-y-3">
                  ...
                  >
                    ...
                    <button
                      ...
                      :style="{ backgroundColor: adaptiveButtonBg }"
                    >
                      <Trash2 :size="20" />
                    </button>
                  </div>
