    ...
    <div class="h-screen bg-page flex flex-col font-inter overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <div
              v-if="isFinalizeDisabled && splitPayment"
            ...
            <div class="flex justify-between gap-4">
              <button
                @click="closeDetails"
                class="px-8 py-3 bg-transparent border border-[#E0E0E0] text-[#757575] font-black uppercase tracking-widest text-xs rounded hover:bg-gray-50 transition-all"
              >
                Cancelar
              </button>
              <button
      ...
      <div
        v-if="showRulesModal"
        class="fixed inset-0 bg-page/50 flex items-center justify-center p-4 z-[110]"
      >
        <div
      ...
      <div
        ...
        class="fixed inset-0 backdrop-blur-xl flex items-center justify-center p-4 z-[120]"
      >
        <div
            ...
            >
              ...
              <div class="mt-8 flex gap-3">
                <button
                  ...
                  class="flex-1 py-3 bg-gray-50 border border-[#E0E0E0] text-[#757575] font-black uppercase text-xs rounded hover:bg-gray-100 transition-all"
                >
                  Cancelar
                </button>
                <button
...
const hasPreparing = computed(() =>
  ordersWithStatus.value.some((o) => o.status === "preparing"),
);
...
function confirmRules(confirm) {
  ...
  if (pendingCancel.value) {
    ...
    pendingOrders.forEach((order) => {
      ...
      selectedComanda.value.orders = selectedComanda.value.orders.filter(
        (o) => o.id !== order.id,
      );
    });
    selectedComanda.value.total = selectedComanda.value.orders.reduce(
