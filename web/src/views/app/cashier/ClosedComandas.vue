        ...
        >
          ...
          >
            <div class="flex items-center gap-4 min-w-0">
              <div
                class="shrink-0 w-11 h-11 rounded bg-accent-light border border-accent/30 flex items-center justify-center"
              >
            ...
            <div class="flex items-center gap-6 shrink-0">
              <div class="text-right hidden sm:block">
                ...
                <p class="text-accent font-black text-xl">
                  {{ formatCurrency(finalTotal(comanda)) }}
                </p>
              </div>
              <component
                :is="expandedId === comanda.id ? ChevronUp : ChevronDown"
                :size="20"
                class="text-[#757575]"
              />
            </div>
            ...
            >
              <div class="p-6 space-y-6">
                <div>
                  ...
                  <div
                    v-if="!comanda.orders || comanda.orders.length === 0"
                  ...
                  <div v-else class="space-y-3">
                    ...
                    >
                      ...
                      >
                        <span
                          class="text-[#212121] font-black text-sm uppercase tracking-widest"
                        >
                          Pedido #{{ order.id }}
                        </span>
                      ...
                      <div class="px-5 py-4 space-y-2">
                        ...
                        >
                          <div class="flex items-center gap-3">
                            <span
                              class="w-6 h-6 rounded bg-gray-50 border border-[#E0E0E0] flex items-center justify-center text-[10px] font-black text-[#757575]"
                            >
                              {{ item.amount || 1 }}x
                            </span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div
                    class="p-5 bg-gray-50 border border-[#E0E0E0] rounded space-y-3"
                  >
                    <h3
                    ...
                    <div class="flex justify-between text-sm">
                      ...
                      <span class="text-[#212121] font-black">{{
                        formatCurrency(comanda.total)
                      }}</span>
                    </div>
                    <div
                      v-if="comanda.paymentDetails?.discountValue"
                    ...
                    <div
                      class="flex justify-between text-sm border-t border-[#E0E0E0] pt-3"
                    >
                      <span
                        class="text-[#212121] font-black uppercase tracking-widest text-xs"
                        >Total Pago</span
                      >
                  ...
                  <div class="p-5 bg-gray-50 border border-[#E0E0E0] rounded">
                    ...
                    <div
                      v-if="paymentSummary(comanda).length === 0"
                      class="text-[#757575] text-xs font-bold"
                    >
                      Não informado.
                    </div>
                    <div v-else class="space-y-2">
                      <div
                        v-for="(p, i) in paymentSummary(comanda)"
                        :key="i"
                        class="flex items-center justify-between"
                      >
