    ...
    <table class="w-full text-left border-collapse min-w-[740px]">
      <thead class="bg-gray-50 text-[#757575] uppercase text-[10px] font-black tracking-widest border-b border-[#E0E0E0]">
        <tr>
          ...
          <th v-if="actions.length || $slots['row-actions']" class="p-4 sm:p-6 text-right whitespace-nowrap">Ações</th>
        </tr>
      </thead>
      <tbody>
        <tr v-for="item in sortedData" :key="item.id"
          ...
          <td v-if="actions.length || $slots['row-actions']" class="p-4 sm:p-6 text-right whitespace-nowrap">
