...
<template>
  <div class="relative w-full flex flex-col gap-1 text-left">
    <label
      v-if="label"
      class="text-xs font-black uppercase tracking-widest ml-1"
    ...
    <div class="relative group">
      <div
        v-if="icon"
        class="absolute left-4 top-1/2 -translate-y-1/2 text-[#757575] group-focus-within:text-accent transition-colors z-10"
      >
