...
<template>
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-12">
    <div
      class="bg-white border border-[#E0E0E0] rounded p-8 flex flex-col min-h-[400px] shadow-sm"
    >
      <h3
      ...
      <div
        ...
        class="flex-grow flex items-end justify-between gap-2 px-2"
      >
        <div
          v-for="h in peakHours"
          :key="h.hora"
          class="w-full flex flex-col items-center h-full justify-end group"
        >
          <div
            class="w-full rounded-t-lg transition-all duration-700 bar-animation shadow-sm"
            :class="
              h.fluxo > 75
          ...
          ></div>
          <span class="mt-4 text-[9px] font-black text-[#757575] uppercase">{{
            h.hora
          }}</span>
        </div>
      </div>
    ...
    >
      <h3
        class="text-sm font-black text-[#212121] mb-12 flex items-center gap-3 uppercase tracking-widest"
      >
          ...
          <div class="flex items-center gap-4 min-w-0">
            ...
            <div class="min-w-0">
              ...
              <span
                ...
                >{{ waiter.orders }} pedidos</span
              >
            </div>
          </div>
          <span class="font-black text-[#212121] text-lg">{{
