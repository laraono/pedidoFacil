...
import rolesImage from '@/assets/image 29.png'
  ...
  <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow">
    <div class="p-6">
      ...
      <div class="h-40 my-4 bg-gray-200 rounded-md overflow-hidden">
        <img :src="rolesImage" alt="Estabelecimento" class="w-full h-full object-cover object-center" />
      </div>

      <p class="text-sm text-gray-600 mb-6">Configurações do estabelecimento</p>
