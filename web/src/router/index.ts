...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/register', name: 'register', component: RegisterManager },
  {
    ...
    children: [
      ...
      { path: "subscription", name: "subscription", component: () => import("@/views/app/subscription/ManagerSubscription.vue"), meta: { requiresAuth: true, permission: PERMISSIONS.ASSINATURA } },
      { path: "admin/subscriptions", name: "admin-subscriptions", component: () => import("@/views/app/admin/AdminSubscriptions.vue"), meta: { requiresAuth: true, requiresAdmin: true } },
      { path: "admin/reports", name: "admin-reports", component: () => import("@/views/app/admin/AdminReports.vue"), meta: { requiresAuth: true, requiresAdmin: true } },
      { path: "admin/users", name: "admin-users", component: () => import("@/views/app/admin/AdminUsers.vue"), meta: { requiresAuth: true, requiresAdmin: true } },
      { path: "settings/profile", name: "manager-profile", component: () => import("@/views/app/settings/ManagerProfile.vue"), meta: { requiresAuth: true } },
    ],
  },
];
