...
export default function WelcomeScreen() {
  ...
  return (
    <TouchableOpacity style={styles.fullScreenBtn} activeOpacity={1} onPress={handleStart}>
      <StatusBar barStyle="light-content" backgroundColor={theme.fundoGeral} />
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.bottomContent}>
          <Animated.View style={[styles.touchIndicator, { transform: [{ scale: pulseAnim }] }]}>
            ...
            <Feather name="arrow-right" size={24} color={theme.textoBotoes} style={styles.pointerIcon} />
          </Animated.View>
        </View>
      </SafeAreaView>
    </TouchableOpacity>
...
const getStyles = (theme) =>
  StyleSheet.create({
    ...
    logoCircle: { width: 150, height: 150, borderRadius: 75, backgroundColor: theme.corBotoes, alignItems: "center", justifyContent: "center", borderWidth: 0.5, borderColor: 'rgba(255, 255, 255, 0.1)', elevation: 15, shadowColor: "#000", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 12 },
