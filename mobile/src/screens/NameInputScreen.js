...
export default function NameInputScreen() {
  ...
  const descontoAplicado = route.params?.descontoAplicado || 0;
  ...
  const pressKey = (key) => setName((prev) => prev + key);
      ...
      >
        <View style={styles.centerWrapper}>
          ...
          <Text style={styles.subtitle}>
            Seu nome aparecerá no pedido para facilitar a retirada.
          </Text>

          <View style={styles.displayBox}>
            <Text
              style={[styles.displayText, !name && styles.displayPlaceholder]}
              numberOfLines={1}
