    ...
    try {
      ...
      if (response.ok) {
        ...
        setTheme({
          ...
          textoSecundario: bgIsLight ? "#424242" : "rgba(255,255,255,0.7)",
          borda: bgIsLight ? "#9E9E9E" : "rgba(255,255,255,0.25)",
          bordaCard: cardIsLight ? "#9E9E9E" : "rgba(255,255,255,0.25)",
